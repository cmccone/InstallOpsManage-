...
#
# Redis IP
REDIS_SERVER = '{{ ansible_default_ipv4['address'] }}'
#
# DB
DB_HOST = 'localhost'
DB_PORT = '3306'
...
BROKER_URL = 'redis://%s:6379/4' % REDIS_SERVER
...
REDSI_KWARGS_LPUSH = {"host":REDIS_SERVER,'port':6379,'db':3}
...
TEMPLATES = [
    {
        ...
        'DIRS': ["/mnt/OpsManage/OpsManage/static/",
		'/mnt/OpsManage/OpsManage/templates/',
		os.path.join('%s/OpsManage/' % BASE_DIR, 'templates'),],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
TEMPLATE_DIRS = (
     os.path.join(BASE_DIR,'OpsManage\templates'),
)
...
STATICFILES_DIRS = (
     ...
     os.path.join('%s/OpsManage/' % BASE_DIR, 'static'),
    )
